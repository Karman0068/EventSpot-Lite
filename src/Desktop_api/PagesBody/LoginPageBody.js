...
function LoginPageBody({ className }) {
  ...
  return (
    <div className={`box-border px-2 gap-3 flex flex-wrap justify-center items-center ${className}`}>
      ...
      <div
        className=" my-10 box-border flex-grow lg:flex-grow-0 p-2 pb-10 min-h-fit h-[70vh] lg:min-h-fit w-full lg:w-[33rem] xl:w-[43rem] border-blue-400 border-2 rounded-xl flex flex-col justify-center items-center"
      >
        <FactTextBox />
        <AuthenticationPanel />
      </div>
